  ...
  return (
    <section className="py-24 px-6 overflow-hidden">
      <div className="text-center mb-14 lg:mb-20">
        ...
        <h2 className="text-3xl lg:text-5xl font-bold tracking-tight mb-2">See It Running</h2>
        <p className="text-white/60 lg:text-xl">Real dashboards. Not mockups.</p>
      </div>

      <motion.div
        className="relative mx-auto w-[280px] h-[580px] lg:scale-[1.1] xl:scale-[1.2] origin-top rounded-[52px] border-[6px] border-[#1a1a1a] bg-black shadow-[0_40px_100px_rgba(0,0,0,0.9),0_0_0_1px_rgba(255,255,255,0.05)]"
