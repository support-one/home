  ...
  return (
    <section className="py-24 px-6 overflow-hidden">
      <div className="text-center mb-14 lg:mb-20">
        ...
        <h2 className="text-3xl lg:text-5xl font-bold tracking-tight mb-2">Built For Every Business</h2>
        <p className="text-white/60 lg:text-xl">Healthcare to Hospitality. We map it.</p>
      </div>

      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6 max-w-sm md:max-w-3xl lg:max-w-6xl mx-auto">
        {industries.map((ind, i) => (
          <motion.div
            key={ind.name}
            className={`relative overflow-hidden group ${i === 0 || i === 5 ? 'col-span-2 h-[180px] lg:h-[280px]' : 'h-[160px] lg:h-[240px]'}`}
