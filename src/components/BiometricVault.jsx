  ...
  return (
    <div className="w-full h-full bg-[#0a0a0a] border border-white/10 rounded-[28px] p-8 flex flex-col items-center justify-center hover:bg-[#0c0c0c] transition-colors duration-300">
      <div className="text-center mb-8">
         <h3 className="text-xl lg:text-2xl font-bold tracking-tight mb-2">The VIP Hotline</h3>
         <p className="text-white/60 text-xs px-2 leading-relaxed">Generic SaaS leaves you in a queue. Custom software gives you direct access.</p>
      </div>
