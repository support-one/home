  ...
  return (
    <section className="py-24 px-6 overflow-hidden">
      <div className="text-center mb-14">
        ...
        <h2 className="text-3xl lg:text-5xl font-bold tracking-tight mb-2">Your Apps. Your Rules.</h2>
        <p className="text-white/60 lg:text-xl">Every tool custom-built for your workflow.</p>
      </div>

      <div className="grid grid-cols-3 lg:flex lg:flex-row lg:justify-center lg:gap-8 gap-4 max-w-xs lg:max-w-5xl mx-auto">
        {apps.map((app, i) => (
          <motion.div
            key={app.name}
          ...
          >
            <motion.div
              className="w-[72px] h-[72px] lg:w-[96px] lg:h-[96px] rounded-[20px] lg:rounded-[28px] flex items-center justify-center shadow-lg relative overflow-hidden transform-gpu hover:scale-110 lg:hover:scale-125 transition-transform"
            ...
            <span className="text-[11px] lg:text-sm text-white/60 font-medium">{app.name}</span>
          </motion.div>
        ))}
      </div>
    </section>
