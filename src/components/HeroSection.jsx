...
const HeroSection = () => {
  ...
  return (
    <section className="relative pt-[calc(env(safe-area-inset-top)+120px)] lg:pt-[calc(env(safe-area-inset-top)+160px)] px-6 lg:px-24 pb-12 min-h-[90vh] flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <motion.h1 
        className="text-[42px] xs:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[1.05] mb-6"
      ...
      <motion.p 
        className="text-lg md:text-2xl text-white/50 font-medium leading-[1.4] mb-12 max-w-[280px] md:max-w-xl lg:max-w-2xl"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      <div className="relative w-full max-w-[320px] lg:max-w-[400px] mt-4 mb-16">
        <motion.div 
