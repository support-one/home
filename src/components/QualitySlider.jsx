...
const QualitySlider = () => {
  ...
  return (
    <section className="py-24 px-6">
      <div className="material-thick p-10 lg:p-16 flex flex-col items-center max-w-sm lg:max-w-4xl mx-auto rounded-[32px] lg:rounded-[48px]">
        <h3 className="text-2xl lg:text-4xl font-bold mb-10 lg:mb-16">Not A SaaS</h3>
        
        <motion.div 
          className="text-4xl lg:text-7xl text-center font-black mb-2 tracking-tighter leading-tight h-20 lg:h-32 flex items-center justify-center"
        ...
        <p className="text-white/50 text-sm lg:text-lg mb-12 lg:mb-20 h-6 text-center">
