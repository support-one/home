      ...
      >
        <div className="px-6 py-4 flex justify-between items-center relative transform-gpu">
          ...
          <motion.button 
            ...
            className="w-10 h-10 rounded-full flex items-center justify-center relative z-[70]" 
          ...
          <>
            ...
            >
              ...
              <div className="mt-auto pt-6 border-t border-white/5">
                ...
                <p className="text-[8px] text-white/10 text-center mt-6 font-mono">v2.1 — Mobile Optimized</p>
              </div>
            </motion.div>
          </>
        )}
