  ...
  return (
    <section className="py-24 px-6 overflow-hidden">
      <div className="text-center mb-14">
        <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-apple-blue block mb-4">Real-Time</span>
        <h2 className="text-3xl font-bold tracking-tight mb-2">Always Updated</h2>
        <p className="text-white/60">Your business, live.</p>
      </div>

      <div className="relative h-[260px] max-w-sm mx-auto perspective-1000">
        <AnimatePresence mode="popLayout">
          {active.map((notifIdx, stackIdx) => {
            ...
            return (
              ...
              >
                <div className="material-thick glare-edge p-4 flex items-center gap-4" style={{ borderRadius: '20px' }}>
                  <div 
                    className="w-11 h-11 rounded-[14px] flex items-center justify-center text-lg font-bold flex-shrink-0 shadow-lg"
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center mb-0.5">
                      ...
                      <span className="text-[9px] text-white/30 font-mono ml-2 flex-shrink-0">{notif.time}</span>
                    </div>
                    <p className="text-xs text-white/50 truncate">{notif.sub}</p>
                  </div>
                </div>
              </motion.div>
            );
